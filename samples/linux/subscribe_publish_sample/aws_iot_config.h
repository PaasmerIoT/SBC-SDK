...
#define AWS_IOT_MQTT_CLIENT_ID         "PAASMER" ///< MQTT client ID should be unique for every device
#define AWS_IOT_MY_THING_NAME 		   "PAASMER" ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_ROOT_CA_FILENAME       "rootCA.crt" ///< Root CA file name
#define AWS_IOT_CERTIFICATE_FILENAME   "e76b102a41-certificate.pem.crt" ///< device signed certificate file name
#define AWS_IOT_PRIVATE_KEY_FILENAME   "e76b102a41-private.pem.key" ///< Device private key filename
// =================================================
